					...
					<div>
						...
						<div class="bg-white border rounded-primary px-5 py-6">
							...
							<div class="flex items-center mt-4">
								<input class="mr-4" type="radio" name="method" id="bkash" value="bkash" v-model="paymentMethod">
								<label class="font-semibold text-sm text-gray-400" for="bkash">M-pesa  Payment</label>
							</div>
							<div class="flex items-center mt-4">
								<input disabled class="mr-4" type="radio" name="method" id="nagad" value="nagad" v-model="paymentMethod">
								<label class="font-semibold text-sm text-gray-400" for="nagad"> VISA /BANK TRANSFERS Payment</label>
							</div>
						</div>
						<!-- Agree-->
