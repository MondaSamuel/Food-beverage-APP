							...
							<table>
								...
								<tbody>
									<tr v-for="(item, index) in cartItems" :key="index">
										<td>
											<div class="h-16 w-16">
												<img data-v-697f7fd0="" src="http://localhost:8000/storage/70/9.png" alt="product" class="h-full w-full" style="object-fit: cover;">
											</div>
										</td>
										<td> {{item.name}} </td>
										...
										<td><span class="font-semibold"> Ksh{{(item.quantity * item.price)}} </span> </td>
										<td>
